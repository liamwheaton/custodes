...
// Authentification
.run(["$http", "$rootScope", "$location", "$cookieStore", function($http, $rootScope, $location, $cookieStore){
...
.controller('mapCtrl', ["$scope", "$rootScope", "$location", "AuthenticationService", "uiGmapGoogleMapApi", "$geolocation", function($scope, $rootScope, $location, AuthenticationService, uiGmapGoogleMapApi, $geolocation) {
...
.controller('regCtrl', ["$scope", "$rootScope", "$location", "AuthenticationService", function($scope, $rootScope, $location, AuthenticationService){
