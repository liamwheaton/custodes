...
angular.module("app.controllers").controller("loginCtrl",["$scope",function(l){l.pageClass="page-login"}]);
...
angular.module("app.controllers").controller("regCtrl",["$scope",function(e){e.pageClass="page-reg"}]);
