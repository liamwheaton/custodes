angular.module("app.controllers",[]),angular.module("app.directives",[]),angular.module("app.resources",[]),angular.module("app.services",[]),angular.module("app.filters",[]),angular.module("app.routes",[]),angular.module("app.views",[]),angular.module("app",["ngRoute","ngAnimate","ngResource","ngSanitize","restangular","app.controllers","app.directives","app.resources","app.services","app.filters","app.routes","app.views"]),angular.element(document).ready(function(){angular.bootstrap(document,["app"])});
angular.module("app.routes").config(["$routeProvider","RestangularProvider",function(e,r){r.setBaseUrl("http://localhost:3000"),e.when("/",{controller:"landingCtrl",templateUrl:"views/landing.html"}).when("/users/login",{controller:"loginCtrl",templateUrl:"views/login.html"}).when("/users/register",{controller:"regCtrl",templateUrl:"views/register.html"}).when("/map",{controller:"mapCtrl",templateUrl:"views/map.html"}).otherwise({redirectTo:"/"})}]).factory("UserRestangular",["Restangular",function(e){return e.withConfig(function(e){e.SetRestangularfields({id:"_id"})})}]).factory("User",["UserRestangular",function(e){return e.service("user")}]);
angular.module("app.controllers").controller("landingCtrl",["$scope",function(l){l.pageClass="page-landing"}]);
angular.module("app.controllers").controller("loginCtrl",["$scope","$http",function(s,e){s.pageClass="page-login",s.users=[{username:"user1",password:"user1"},{username:"user2",password:"user2"}]}]);
angular.module("app.controllers").controller("mainCtrl",["$scope",function(l){l.siteTitle="Custodes"}]);
angular.module("app.controllers").controller("mapCtrl",["$scope",function(s){s.pageClass="page-map",s["class"]="close",s.changeClass=function(){"close"===s["class"]?s["class"]="open":s["class"]="close"}}]);
angular.module("app.controllers").controller("regCtrl",["$scope","$http",function(e,l){e.pageClass="page-reg"}]);
