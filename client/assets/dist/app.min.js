...
angular.module("app.controllers").controller("mapCtrl",["$scope","User","$routeParams","uiGmapGoogleMapApi",function(e,o,s,a){e.map={center:{latitude:45,longitude:-73},zoom:8},e.pageClass="page-map",e["class"]="close",e.changeClass=function(){"close"===e["class"]?e["class"]="open":e["class"]="close"},e.users=o.one(s.id).get().$object,a.then(function(e){})}]);
