angular.module("app.controllers",[]),angular.module("app.directives",[]),angular.module("app.resources",[]),angular.module("app.services",[]),angular.module("app.filters",[]),angular.module("app.routes",[]),angular.module("app.views",[]),angular.module("app",["ngRoute","ngAnimate","ngResource","ngSanitize","app.controllers","app.directives","app.resources","app.services","app.filters","app.routes","app.views"]),angular.element(document).ready(function(){angular.bootstrap(document,["app"])});
...
angular.module("app.controllers").controller("loginCtrl",["$scope","$http",function(e,o){e.pageClass="page-login",o.get("/users").success(function(o){console.log("data recieved"),e.users=o})}]);
