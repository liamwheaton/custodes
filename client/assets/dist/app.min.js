...
.controller('landingCtrl', ["$scope", "AuthenticationService", "$rootScope", function($scope, AuthenticationService, $rootScope) {
	$scope.pageClass = 'page-landing';
	console.log($rootScope);
}]);
angular.module('app.controllers')

.controller('loginCtrl', ["$rootScope", "$scope", "$location", "AuthenticationService", function($rootScope, $scope, $location, AuthenticationService) {
...
.controller('mapCtrl', ["$scope", "$rootScope", "$location", "$http", "AuthenticationService", "uiGmapGoogleMapApi", "$geolocation", "PinService", function($scope, $rootScope, $location, $http, AuthenticationService, uiGmapGoogleMapApi, $geolocation, PinService) {
...
.controller('regCtrl', ["$scope", "$rootScope", "$location", "$http", "AuthenticationService", function($scope, $rootScope, $location, $http, AuthenticationService) {
...
.directive('emailValidate', ["$http", "$q", function($http, $q){
	return {
		require: 'ngModel',
...
.directive('serverError', ["$http", "$q", function($http, $q) {
	return {
		restrict: 'A',
		require: '?ngModel',
...
.directive('usernameValidate', ["$http", "$q", function($http, $q){
	return {
		require: 'ngModel',
		link: function(scope, element, attrs, ngModel) {
...
$templateCache.put("views/map.html","<div nav-bar></div>\r\n<div ping-btn></div>\r\n<div pin-btn></div>\r\n<div center-btn></div>\r\n<ui-gmap-google-map center=\"map.center\" zoom=\"map.zoom\" options=\"options\" bounds=\"map.bounds\">\r\n	<ui-gmap-markers models=\"Markers\" coords=\"\'self\'\" icon=\"\'icon\'\" idkey=\"id\" click=\"onClick\">\r\n		<ui-gmap-windows show=\"show\">\r\n			<div class=\"window\">\r\n				<div>\r\n					<a>{{ username }}</a>\r\n					<div class=\"time-container\">\r\n						<p>10m</p>\r\n						<div class=\"votes\">\r\n							<button class=\"up vote\"><i class=\"fa fa-caret-up\"></i></button>\r\n							<button class=\"down vote\"><i class=\"fa fa-caret-down\"></i></button>\r\n						</div>\r\n					</div>\r\n				</div>\r\n			</div>\r\n		</ui-gmap-windows>\r\n	</ui-gmap-markers>\r\n</ui-gmap-google-map>\r\n<div drawer></drawer>\r\n\r\n");
$templateCache.put("views/register.html","<div class=\"form-view\">\r\n\r\n	<div class=\"custodes-logo\"></div>\r\n\r\n	<div class=\"content\">\r\n		<div class=\"wrapper\">\r\n			<h1>Register</h1>\r\n		</div>\r\n\r\n		<div reg-form></div>\r\n\r\n	</div>\r\n\r\n	<footer>\r\n		<div>	\r\n			<p>© Custodes</p>\r\n			<a href=\"#\"><i class=\"fa fa-facebook-official\"></i></a>\r\n			<a href=\"#\"><i class=\"fa fa-twitter-square\"></i></a>\r\n		</div>\r\n	</footer>\r\n\r\n</div>");
...
$templateCache.put("directives/templates/loginTemp.html","<div class=\"wrapper\">\r\n\r\n	<form class=\"form-container\" name=\"formContainer\" ng-submit=\"login()\" role=\"form\" novalidate>\r\n\r\n		<div class=\"form-row\">\r\n			<input type=\"text\" name=\"username\" placeholder=\"Username\" ng-model=\"username\" ng-model-options=\"{ updateOn: \'submit\' }\" server-error>\r\n		</div>\r\n\r\n		<!-- /^[A-Za-z0-9à-ú-_\\.]{6,8}$/ -->\r\n\r\n		<div class=\"form-row\">\r\n			<input type=\"password\" name=\"password\" placeholder=\"Password\"  ng-model=\"password\" ng-model-options=\"{ updateOn: \'submit\' }\" server-error>\r\n		</div>\r\n		\r\n		<div class=\"form-validation\">\r\n\r\n			<button type=\"submit\" class=\"btn\">Login</button>\r\n\r\n			<div ng-show=\"formContainer.password.$dirty && formContainer.password.$invalid\">\r\n				<span class=\"error\" ng-show=\"formContainer.password.$error.server\">{{ error }}</span>\r\n			</div>\r\n\r\n		</div>\r\n\r\n		<a class=\"link\" href=\"#\">I\'ve forgotten my details</a>\r\n		<a class=\"link\" href=\"#/register\">Create an account</a>\r\n		\r\n	</form>\r\n	\r\n</div>");
...
$templateCache.put("directives/templates/regTemp.html","<div class=\"wrapper\">\r\n	\r\n	<form class=\"form-container\" name=\"formContainer\" ng-submit=\"signUp()\" ng-click=\"clicked()\" role=\"form\" novalidate>\r\n\r\n		<div class=\"form-row\">\r\n			<input type=\"text\" name=\"username\" placeholder=\"Username\" ng-model=\"username\" ng-minlength=\"3\" ng-maxlength=\"16\" username-validate ng-model-options=\"{ updateOn: \'blur\' }\" required>\r\n		</div>\r\n\r\n		<div class=\"form-row\">\r\n			<input type=\"email\" name=\"email\" placeholder=\"E-mail\" ng-model=\"email\"  required>\r\n		</div>\r\n\r\n		<div class=\"form-row\">\r\n			<input type=\"password\" name=\"password\" placeholder=\"Password\" ng-model=\"password\" ng-minlength=\"8\" required>\r\n		</div>\r\n\r\n		<div class=\"form-row\">\r\n			<input type=\"password\" name=\"passwordConfirm\" placeholder=\"Confirm password\" ng-model=\"passwordConfirm\" compare-to=\"password\" required>\r\n		</div>\r\n		\r\n		<div class=\"terms\">\r\n			<input type=\"checkbox\" name=\"terms\" ng-model=\"terms\" required>\r\n			<label for=\"\">Accept</label>\r\n			<a href=\"#\">Terms and Conditions</a>\r\n		</div>\r\n		\r\n		<div class=\"form-validation\">\r\n\r\n			<button type=\"submit\" class=\"btn\" ng-disabled=\"formContaier.$invalid\" >Sign up</button>\r\n\r\n			<div class=\"error\" ng-messages=\"formContainer.terms.$error\" ng-show=\"formContainer.passwordConfirm.$touched\">\r\n				<div ng-message=\"required\">Please accept terms</div>\r\n			</div>\r\n\r\n			<div class=\"error\" ng-messages=\"formContainer.passwordConfirm.$error\" ng-show=\"formContainer.passwordConfirm.$touched\">\r\n				<div ng-message=\"required\">Please confirm password</div>\r\n				<div ng-message=\"compareTo\">Password does not match</div>\r\n			</div>\r\n\r\n			<div class=\"error\" ng-messages=\"formContainer.password.$error\" ng-show=\"formContainer.password.$touched\">\r\n				<div ng-message=\"required\">Password required</div>\r\n				<div ng-message=\"minlength\">Min 8 characters required</div>\r\n			</div>\r\n			\r\n			<div ng-if=\"formContainer.$error.email\" class=\"error\">Email already in use</div>\r\n\r\n			<div class=\"error\" ng-messages=\"formContainer.email.$error\" ng-show=\"formContainer.email.$touched\">\r\n				<div ng-message=\"required\">Email required</div>\r\n				<div ng-message=\"email\">Email invalid</div>\r\n			</div>\r\n\r\n			<div ng-if=\"formContainer.$error.username\" class=\"error\">Username already in use</div>\r\n\r\n			<div class=\"error\" ng-messages=\"formContainer.username.$error\" ng-show=\"formContainer.username.$touched\">\r\n				<div ng-message=\"required\">Username required</div>\r\n				<div ng-message=\"minlength\">3-16 characters required</div>\r\n				<div ng-message=\"maxlength\">3-16 characters required</div>\r\n			</div>\r\n\r\n		</div>\r\n\r\n	</form>\r\n\r\n\r\n	\r\n</div>");
