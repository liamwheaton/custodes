...
angular.module("app.controllers").controller("mapCtrl",["$scope","User","$routeParams","uiGmapGoogleMapApi","$geolocation",function(o,e,t,a,n){o.pageClass="page-map",o["class"]="close",o.changeClass=function(){"close"===o["class"]?o["class"]="open":o["class"]="close"},n.getCurrentPosition({timeout:6e4}).then(function(e){o.myPosition=e}),n.watchPosition({timeout:6e4,maximumAge:250,enableHighAccuracy:!0}),o.$watch("myPosition.coords",function(e,t){o.map={center:{latitude:e.latitude,longitude:e.longitude},zoom:16}})}]);
