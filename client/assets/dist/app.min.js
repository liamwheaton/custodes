angular.module("app.controllers",[]),angular.module("app.directives",[]),angular.module("app.resources",[]),angular.module("app.services",[]),angular.module("app.filters",[]),angular.module("app.routes",[]),angular.module("app.views",[]),angular.module("app",["ngRoute","ngAnimate","ngCookies","ngResource","ngSanitize","restangular","uiGmapgoogle-maps","ngGeolocation","app.controllers","app.directives","app.resources","app.services","app.filters","app.routes","app.views"]).run(["$http","$rootScope","$location","$cookieStore",function(a,e,o,r){e.globals=r.get("globals")||{},e.globals.currentUser&&(a.defaults.headers.common.Authorization="Basic "+e.globals.currentUser.authdata)}]),angular.element(document).ready(function(){angular.bootstrap(document,["app"])});
...
angular.module("app.controllers").controller("loginCtrl",["$rootScope","$scope","$location","AuthenticationService",function(o,e,a,n){e.pageClass="page-login",n.ClearCredentials(),e.login=function(){e.dataLoading=!0,n.Login(e.username,e.password,function(o){o.success?(n.SetCredentials(e.username,e.password),a.path("/map")):(e.error=o.message,e.dataLoading=!1)})},console.log(o)}]);
angular.module("app.controllers").controller("mainCtrl",["$scope",function(l){l.siteTitle="Custodes"}]);
angular.module("app.controllers").controller("mapCtrl",["$scope","$rootScope","$location","AuthenticationService","uiGmapGoogleMapApi","$geolocation",function(t,o,e,n,a,i){t.pageClass="page-map",t["class"]="close",t.changeClass=function(){"close"===t["class"]?t["class"]="open":t["class"]="close"},t.logout=function(){n.ClearCredentials(),e.path("/")},i.getCurrentPosition({timeout:6e4}).then(function(o){t.myPosition=o}),i.watchPosition({timeout:6e4,maximumAge:250,enableHighAccuracy:!0}),t.$watch("myPosition.coords",function(o,e){t.map={center:{latitude:o.latitude,longitude:o.longitude},zoom:16,bounds:{}};var n=function(t,o,e){var n=o.southwest.latitude,a=o.northeast.latitude-n,i=o.southwest.longitude,u=o.northeast.longitude-i;null===e&&(e="id");var s=n+Math.random()*a,l=i+Math.random()*u,r={latitude:s,longitude:l,title:"m"+t,id:t};return r[e]=t,r};t.randomMarkers=[],t.$watch(function(){return t.map.bounds},function(o,e){if(!e.southwest&&o.southwest){for(var a=[],i=0;50>i;i++)a.push(n(i,t.map.bounds));t.randomMarkers=a}},!0),console.log(t),t.recenter=function(){i.getCurrentPosition({timeout:6e4}).then(function(o){t.myPosition=o})}})}]);
angular.module("app.controllers").controller("regCtrl",["$scope","$rootScope","$location","AuthenticationService",function(e,a,n,o){e.pageClass="page-reg",o.ClearCredentials(),e.SignUp=function(){e.dataLoading=!0,o.SignUp(e.username,e.password,function(a){a.success?(o.SetCredentials(e.username,e.password),n.path("/map")):(e.error=a.message,e.dataLoading=!1)})}}]);
...
angular.module("app.directives").directive("pinBtn",function(){return{restrict:"A",template:'<button class="pin mapbtn"><i class="fa fa-video-camera"></i></button>'}});
