angular.module("app.controllers",[]),angular.module("app.directives",[]),angular.module("app.resources",[]),angular.module("app.services",[]),angular.module("app.filters",[]),angular.module("app.routes",[]),angular.module("app.views",[]),angular.module("app",["ngRoute","ngResource","ngSanitize","app.controllers","app.directives","app.resources","app.services","app.filters","app.routes","app.views"]),angular.element(document).ready(function(){angular.bootstrap(document,["app"])});
...
angular.module("app.controllers").controller("landingCtrl",["$scope",function(l){}]);
angular.module("app.controllers").controller("loginCtrl",["$scope",function(l){}]);
angular.module("app.controllers").controller("mainCtrl",["$scope",function(l){l.siteTitle="Custodes"}]);
angular.module("app.controllers").controller("mapCtrl",["$scope",function(l){l["class"]="close",l.changeClass=function(){"close"===l["class"]?l["class"]="open":l["class"]="close"}}]);
angular.module("app.controllers").controller("regCtrl",["$scope",function(l){}]);
