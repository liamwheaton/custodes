angular.module("app.controllers",[]),angular.module("app.directives",[]),angular.module("app.resources",[]),angular.module("app.services",[]),angular.module("app.filters",[]),angular.module("app.routes",[]),angular.module("app.views",[]),angular.module("app",["ngRoute","ngAnimate","ngResource","ngSanitize","restangular","uiGmapgoogle-maps","ngGeolocation","app.controllers","app.directives","app.resources","app.services","app.filters","app.routes","app.views"]),angular.element(document).ready(function(){angular.bootstrap(document,["app"])});
angular.module("app.routes").config(["$routeProvider","RestangularProvider","uiGmapGoogleMapApiProvider",function(e,r,t){t.configure({key:"AIzaSyBY72HDRm-tIkHB7naH0pykymeIwl3ibGI"}),r.setBaseUrl("http://127.0.0.1:3000"),e.when("/",{controller:"landingCtrl",templateUrl:"views/landing.html"}).when("/user/login",{controller:"loginCtrl",templateUrl:"views/login.html"}).when("/user/register",{controller:"regCtrl",templateUrl:"views/register.html"}).when("/user/:id/edit",{controller:"editCtrl",templateUrl:"views/edit.html"}).when("/user/:id/delete",{controller:"deleteCtrl"}).when("/map",{controller:"mapCtrl",templateUrl:"views/map.html"}).otherwise({redirectTo:"/"})}]).factory("UserRestangular",["Restangular",function(e){return e.withConfig(function(e){e.setRestangularFields({id:"_id"})})}]).factory("PinRestangular",["Restangular",function(e){return e.withConfig(function(e){e.setRestangularFields({id:"_id"})})}]).factory("User",["UserRestangular",function(e){return e.service("user")}]).factory("Pin",["UserRestangular",function(e){return e.service("pin")}]);


angular.module("app.controllers").controller("landingCtrl",["$scope",function(l){l.pageClass="page-landing"}]);
angular.module("app.controllers").controller("loginCtrl",["$scope","User","$routeParams",function(e,o,l){e.pageClass="page-login",e.users=o.one(l.id).get().$object}]);
angular.module("app.controllers").controller("mainCtrl",["$scope",function(l){l.siteTitle="Custodes"}]);
angular.module("app.controllers").controller("mapCtrl",["$scope","$routeParams","uiGmapGoogleMapApi","$geolocation","User","Pin",function(o,e,t,a,i,s){o.pageClass="page-map",o["class"]="close",o.changeClass=function(){"close"===o["class"]?o["class"]="open":o["class"]="close"},a.getCurrentPosition({timeout:6e4}).then(function(e){o.myPosition=e}),a.watchPosition({timeout:6e4,maximumAge:250,enableHighAccuracy:!0}),o.$watch("myPosition.coords",function(e,t){o.pins=s.getList().$object,console.log(o),o.map={center:{latitude:e.latitude,longitude:e.longitude},zoom:16};var a={id:1,latitude:-36.849562600000006,longitude:174.7529218};o.markers=[],o.markers[0]=a})}]);
angular.module("app.controllers").controller("regCtrl",["$scope","User","$location",function(e,o,r){e.pageClass="page-reg",e.user={},e.saveUser=function(){o.post(e.user).then(function(){r.path("/user/login")})}}]);
