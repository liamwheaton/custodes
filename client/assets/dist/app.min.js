angular.module("app.controllers",[]),angular.module("app.directives",[]),angular.module("app.resources",[]),angular.module("app.services",[]),angular.module("app.filters",[]),angular.module("app.routes",[]),angular.module("app.views",[]),angular.module("app",["ngRoute","ngAnimate","ngCookies","ngResource","ngSanitize","restangular","uiGmapgoogle-maps","ngGeolocation","app.controllers","app.directives","app.resources","app.services","app.filters","app.routes","app.views"]).run(["$http","$rootScope","$location","$cookieStore",function(a,e,o,r){e.globals=r.get("globals")||{},e.globals.currentUser&&(a.defaults.headers.common.Authorization="Basic "+e.globals.currentUser.authdata),e.$on("$locationChangeStart",function(a,r,l){"/login"===o.path()||"/register"===o.path()||e.globals.currentUser||o.path("/login")})}]),angular.element(document).ready(function(){angular.bootstrap(document,["app"])});
...
angular.module("app.controllers").controller("landingCtrl",["$scope",function(l){l.pageClass="page-landing"}]);
...
angular.module("app.controllers").controller("mapCtrl",["$scope","$rootScope","$location","AuthenticationService","uiGmapGoogleMapApi","$geolocation",function(o,e,t,c,n,a){o.pageClass="page-map",o["class"]="close",o.changeClass=function(){"close"===o["class"]?o["class"]="open":o["class"]="close"},a.getCurrentPosition({timeout:6e4}).then(function(e){o.myPosition=e}),a.watchPosition({timeout:6e4,maximumAge:250,enableHighAccuracy:!0}),o.$watch("myPosition.coords",function(e,t){o.map={center:{latitude:e.latitude,longitude:e.longitude},zoom:16}}),console.log(e)}]);
...
angular.module("app.directives").directive("centerBtn",function(){return{restrict:"A",template:'<button class="center mapbtn"><i class="fa fa-crosshairs"></i></button>'}});
...
angular.module("app.services").factory("AuthenticationService",["Base64","$http","$cookieStore","$rootScope","$timeout",function(e,r,a,t,n){var o={};return o.Login=function(e,a,t){r.post("/api/authenticate",{username:e,password:a}).success(function(e){t(e)}),n(function(){var r={success:"test"===e&&"test"===a};r.success||(r.message="Username or password is incorrect"),t(r)},1e3)},o.SignUp=function(e,a,t){r.post("/api/users",{username:e,password:a}).success(function(e){t(e)}).error(function(e){t(e)})},t.loggedIn=function(){return t.globals&&t.globals.currentUser?!0:!1},t.getUsername=function(){return t.loggedIn()?t.globals.currentUser.username:void 0},o.SetCredentials=function(n,o){var s=e.encode(n+":"+o);t.globals={currentUser:{username:n,authdata:s}},r.defaults.headers.common.Authorization="Basic "+s,a.put("globals",t.globals)},o.ClearCredentials=function(){t.globals={},a.remove("globals"),r.defaults.headers.common.Authorization="Basic "},o}]).factory("Base64",function(){var e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";return{encode:function(r){var a,t,n,o,s,c="",i="",u="",d=0;do a=r.charCodeAt(d++),t=r.charCodeAt(d++),i=r.charCodeAt(d++),n=a>>2,o=(3&a)<<4|t>>4,s=(15&t)<<2|i>>6,u=63&i,isNaN(t)?s=u=64:isNaN(i)&&(u=64),c=c+e.charAt(n)+e.charAt(o)+e.charAt(s)+e.charAt(u),a=t=i="",n=o=s=u="";while(d<r.length);return c},decode:function(r){var a,t,n,o,s,c="",i="",u="",d=0,l=/[^A-Za-z0-9\+\/\=]/g;l.exec(r)&&window.alert("There were invalid base64 characters in the input text.\nValid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='\nExpect errors in decoding."),r=r.replace(/[^A-Za-z0-9\+\/\=]/g,"");do n=e.indexOf(r.charAt(d++)),o=e.indexOf(r.charAt(d++)),s=e.indexOf(r.charAt(d++)),u=e.indexOf(r.charAt(d++)),a=n<<2|o>>4,t=(15&o)<<4|s>>2,i=(3&s)<<6|u,c+=String.fromCharCode(a),64!=s&&(c+=String.fromCharCode(t)),64!=u&&(c+=String.fromCharCode(i)),a=t=i="",n=o=s=u="";while(d<r.length);return c}}});
